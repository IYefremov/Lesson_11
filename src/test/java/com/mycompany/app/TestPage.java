//        1. Create a new Maven project; - Done
//        2. Add TestNG dependency and Selenium Web Driver; -Done
//        3. Add several test classes and 4-5 tests to each class.-Done
//        4. Write @BeforeTest method where you should create your instance of a
//        WebDriver. -Done
//        5. Write @AfterTest method where you should close your browser.-Done
//        6. Add a testng.xml configuration file. -Done
//        7. Configure the test suite to run all tests from the first class and only two from the second. -Done
//        8. Create a @DataProvider method to generate some data for your tests. -Done
//        9. Add your data provider to any test you wish." -Done
